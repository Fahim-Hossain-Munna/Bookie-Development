            ...
            <div class="card-body">
                <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-check form-switch form-switch-info mt-3">
                        <input class="form-check-input" type="checkbox" id="customSwitchInfo" name="feature">
                        <label class="form-check-label" for="customSwitchInfo">Feature</label>
                    </div>
                    <div class="form-check form-switch form-switch-info mt-3">
                        <input class="form-check-input" type="checkbox" id="customSwitchInfo" name="today_sale">
