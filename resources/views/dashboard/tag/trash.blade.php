...
<x-back-page-header title="Tag Trash"></x-back-page-header>
                                ...
                                <td class="text-end">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dLabel11" style="">
                                            <a class="dropdown-item" href="{{ route('tag.trash.restore',$tag->id) }}"> <i class="ti ti-pencil"></i>  Restore</a>
                                            <form action="{{ route('tag.trash.delete',$tag->id) }}" method="get">
